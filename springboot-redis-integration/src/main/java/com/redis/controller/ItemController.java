...
public class ItemController {
    ...
    @ResponseBody
    public ResponseEntity<Map<Integer,Item>> getListItems()
    {
    	//Map<Integer,Item> items =  itemRepo.getAllItems();
    	return new ResponseEntity<Map<Integer,Item>>(itemRepo.getAllItems(),HttpStatus.OK);
    }
    ...
    public ResponseEntity<Item> getItem(@PathVariable int itemId){
       // Item item = itemRepo.getItem(itemId);
        return new ResponseEntity<Item>(itemRepo.getItem(itemId), HttpStatus.OK);
    }
